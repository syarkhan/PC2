...
public class FragmentsHandler {
    ...
    private static final String EXTRA_TAG_COUNT = FragmentsHandler.class.getName() + ":EXTRA_TAG_COUNT";
    private static final String EXTRA_SELECTED_TAB_INDEX = FragmentsHandler.class.getName() + ":EXTRA_SELECTED_TAB_INDEX";
    private static final String EXTRA_CURRENT_FRAGMENT = FragmentsHandler.class.getName() + ":EXTRA_CURRENT_FRAGMENT";
    private static final String EXTRA_FRAGMENT_STACK = FragmentsHandler.class.getName() + ":EXTRA_FRAGMENT_STACK";

    private int mContainerId;

    private HashMap<Integer, Stack<Fragment>> mFragmentStacks;
    ...
    public FragmentsHandler(int mContainerId, FragmentManager mFragmentManager, Fragment mCurrentFrag,Integer mSelectedTabIndex) {
        this.mContainerId = mContainerId;
        this.mFragmentManager = mFragmentManager;
        this.mCurrentFrag = mCurrentFrag;
        this.mSelectedTabIndex=mSelectedTabIndex;
        mFragmentStacks = new HashMap<Integer, Stack<Fragment>>();
        mFragmentStacks.put(TAB1, new Stack<Fragment>());
        mFragmentStacks.put(TAB2, new Stack<Fragment>());
        mFragmentStacks.put(TAB3, new Stack<Fragment>());
        mFragmentStacks.put(TAB4, new Stack<Fragment>());
    }

//    public void addFragmentsToStack(Fragment fragment)
//    {
...
//    }
    ...
    public void setCurrentFrag(Fragment mCurrentFrag) {
        this.mCurrentFrag = mCurrentFrag;
    }
